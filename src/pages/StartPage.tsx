          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <CpuChipIcon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-4">
                <PresentationChartBarIcon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-slate-900 mb-2">
                    Product Managers
                  </h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <CodeBracketIcon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-slate-900 mb-2">
                    Engineering Teams
                  </h3>
              ...
              <div className="flex items-start space-x-4">
                <ChatBubbleLeftRightIcon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-slate-900 mb-2">
